...
const componentConvertAnimatorArea = (send_MediaObjectID: string) => {
  ...
  for (let gi = 0; gi < AnimatorGroupIDArray.length; gi++) {
    ...
    const AnimatorGroupClass =
      middleDataOperation.getOwnedClassAnimatorGroup(AnimatorGroupID);

    const AnimatorIDArray =
      middleDataOperation.getOwnedID_Animator(AnimatorGroupID);
    ...
    <div>
      <AppContext.Provider
        value={{
          ...
          getMediaObjectSourceType:
            middleDataOperation.getMediaObjectSourceType,
          ...
          rewriteMediaObejctAnimatorOpen:
            middleDataOperation.rewriteMediaObejctAnimatorOpen,
          getMediaObejctAnimatorOpen:
            middleDataOperation.getMediaObejctAnimatorOpen,
